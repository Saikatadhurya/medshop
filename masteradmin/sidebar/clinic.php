<div class="row">
              ...
              <div class="container-fluid">
                ...
                <div class="col-sm-4">
                  ...
                  <input class="form-control" type="text" placeholder="Search for Clinic" id="myInput" onkeyup="myFunction()" title="Type in a name">
                ...
                <br>
                      ...
                      <table class="table table-striped table-advance table-hover" id="myTable">
                              ...
                              <br><h3><i class="fa fa-angle-right"></i>APPROVE CLINICS HERE</h3>
...
<p class="col"><button class="btn btn-danger btn-sm ml-1 ml-sm-0"><i class="fas fa-trash"></i></button> Delete</p>
                          ...
                          <tr>
                                  ...
                                  <th><i class="fa fa-question-circle"></i> Clinic's Name</th>
								  ...
								  <th><i class="far fa-sticky-note"></i> Area</th>

								  <th><i class="fas fa-image"></i> Address</th>
...
$sql = "select * from clinic where city='$city' and status=0";
...
?>
 ...
 <tr>
    ...
    <td>
        ...
        <a href="approveclinic.php?approve=<?php echo $id;?>"> <button class="btn btn-success btn-md"><i class="far fa-check-circle"></i></button></a>
...
<a href="deleteclinic.php?del=<?php echo $id;?>" class="btn btn-danger">Delete</a>
